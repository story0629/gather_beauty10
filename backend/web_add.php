	...
	<?php if (isset($_SESSION["USER"])){ ?>
		<?php if ($_SESSION["LEVEL"]==0) { ?>
			...
			<div class="container backend graphic_add">
				<h1>新增網頁設計作品</h1>
				<form action="web_add_OK.php" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="form-group">
						<label class="col-md-2 col-sm-12 col-xs-12">名稱</label>
						<input type="text" name="name" class="col-md-10 col-sm-12 col-xs-12">
					</div>
					<div class="form-group">
						<label class="col-md-2 col-sm-12 col-xs-12">URL</label>
						<input type="text" name="url" class="col-md-10 col-sm-12 col-xs-12">
					</div>
					<div class="form-group">
